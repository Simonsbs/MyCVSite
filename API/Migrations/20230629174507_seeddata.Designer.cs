...
namespace MyCVSite.API.Migrations
{
    ...
    [Migration("20230629174507_seeddata")]
            ...
            modelBuilder.Entity("MyCVSite.API.Models.DTO.ProgrammingSkill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Category = "Languages",
                            KnownFrom = new DateTime(2022, 6, 29, 20, 45, 7, 197, DateTimeKind.Local).AddTicks(2311),
                            Name = "C#"
                        },
                        new
                        {
                            ID = 2,
                            Category = "Languages",
                            KnownFrom = new DateTime(2020, 6, 29, 20, 45, 7, 197, DateTimeKind.Local).AddTicks(2318),
                            Name = "JavaScript"
                        },
                        new
                        {
                            ID = 3,
                            Category = "Libraries",
                            KnownFrom = new DateTime(2021, 6, 29, 20, 45, 7, 197, DateTimeKind.Local).AddTicks(2321),
                            Name = "React"
                        });
                });
            ...
            modelBuilder.Entity("MyCVSite.API.Models.DTO.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GitURL = "https://github.com/Simonsbs",
                            Name = "Mock Project 1",
            ...
            modelBuilder.Entity("MyCVSite.API.Models.DTO.ProjectGalleryImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "The first image for our project",
                            ProjectID = 1,
            ...
            modelBuilder.Entity("MyCVSite.API.Models.DTO.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            LastLogin = new DateTime(2023, 6, 29, 20, 45, 7, 197, DateTimeKind.Local).AddTicks(2047),
                            Password = "1234",
                            Type = 999,
                            Username = "Simon"
                        });

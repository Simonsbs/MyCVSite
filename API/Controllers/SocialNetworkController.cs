...
namespace MyCVSite.API.Controllers {
	...
	public class SocialNetworkController : Controller {
		...
		public SocialNetworkController(ISocialNetworkRepository _repo) {
		...
		[HttpPost]
		public IActionResult Create(SocialNetwork item) {
			if (item == null) {
				return BadRequest();
			}
		...
		[HttpPut]
		public IActionResult Update(SocialNetwork item) {
			if (item == null) {
				return BadRequest();
			}
